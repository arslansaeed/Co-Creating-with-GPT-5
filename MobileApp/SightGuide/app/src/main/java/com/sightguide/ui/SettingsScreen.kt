...
fun SettingsScreen(
    ...
    //val selectedModel = settingsViewModel.selectedAiModel  # for prototype we disabled it as it is working in notebook
    ...
    Column(
        ...
        Card(
            modifier = Modifier
                .fillMaxWidth()
                .semantics {
                    contentDescription = "Fall detection and alert management section"
                },
            colors = CardDefaults.cardColors(
                containerColor = Color(0xFF2A2A2A),
                contentColor = Color.White
            ...
            Column(
                ...
                Text(
                    text = "Fall Detection & Alert Management",
                    fontSize = 22.sp,
                    fontWeight = FontWeight.SemiBold,
                    color = Color.White,
                    modifier = Modifier.semantics {
                ...
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
                        .semantics(mergeDescendants = true) {
                            contentDescription = "Fall detection. Auto-alert emergency contact via call or email on fall. ${if (settingsViewModel.fallDetectionEnabled) "Enabled" else "Disabled"}"
                        },
                    verticalAlignment = Alignment.CenterVertically,
                    horizontalArrangement = Arrangement.SpaceBetween
                ) {
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Text(
                            text = "Auto-alert emergency contact via call or email on fall",
                            fontSize = 16.sp,
                            color = Color.Gray
                        )
                    }
                    Switch(
                        checked = settingsViewModel.fallDetectionEnabled,
                        onCheckedChange = { settingsViewModel.toggleFallDetection(it) },
                        modifier = Modifier
                            .size(width = 64.dp, height = 40.dp)
                            .semantics {
                                contentDescription = "Toggle Fall Detection"
                            },
                        colors = SwitchDefaults.colors(
                            checkedThumbColor = Color.White,
                            checkedTrackColor = Color(0xFF4CAF50),
                ...
                Button(
                    onClick = { /* Handle emergency contact setup */ },
                    modifier = Modifier
                        .fillMaxWidth()
                        .semantics {
                            contentDescription = "Set up emergency contact"
                        },
                    colors = ButtonDefaults.buttonColors(
                        containerColor = Color(0xFF2196F3),
                        contentColor = Color.White
                    ),
                    enabled = settingsViewModel.fallDetectionEnabled
                ) {
                    Text(
