...
//    }
    ...
    fun submitTextQuery(query: String) {
        ...
        _sceneDescription.value = "..." // Optionally clear or set to a processing message
...
//    }
    ...
    // this is for testing later i will use above one
    fun toggleVoiceInput() {
        val newState = !_isRecordingVoice.value
        _isRecordingVoice.value = newState
...
//
//        // Build LlmInferenceOptions with a result listener
//        val options = LlmInferenceOptions.builder()
//            .setModelPath(modelPath)
//            //.setEnableVisionModality(true)
...
//
//                viewModelScope.launch {
//                    _gemmaResponseFlow.emit(stringBuilder.toString())
//                }
//
//                if (done) {
//                    _sceneDescription.value = stringBuilder.toString()
...
//            .build()
//
//        // Create and return the LlmInference instance
